...
async function createWebAppTemplate(projectName: string, options: ProjectOptions) {
...
async function copyTemplateFiles(targetPath: string, projectName: string) {
...
async function createTemplateFile(filePath: string, fileName: string, projectName: string) {
...
function getTemplateContent(fileName: string, projectName: string): string | null {
  switch (fileName) {
    case 'index.html':
      return `<!doctype html>
<html lang="en">
